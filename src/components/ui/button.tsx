    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-indigo-600 text-white shadow hover:bg-indigo-600/90": variant === "default",
            "bg-zinc-100 text-zinc-900 shadow-sm hover:bg-zinc-200 dark:bg-zinc-800 dark:text-zinc-50 dark:hover:bg-zinc-800/80": variant === "secondary",
